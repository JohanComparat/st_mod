...
nohup python extract_erosita_tile_glist.py 13 > logs/extract_erosita_glist_tile_13.log & # ONGOING 'z0p63',
nohup python extract_erosita_tile_glist.py 14 > logs/extract_erosita_glist_tile_14.log & # ONGOING 'z0p70',
nohup python extract_erosita_tile_glist.py 15 > logs/extract_erosita_glist_tile_15.log & # ONGOING 'z0p78',
nohup python extract_erosita_tile_glist.py 16 > logs/extract_erosita_tile_16.log & # ONGOING 'z0p86',
nohup python extract_erosita_tile_glist.py 17 > logs/extract_erosita_tile_17.log & # ONGOING 'z0p94',
nohup python extract_erosita_tile_glist.py 18 > logs/extract_erosita_tile_18.log & # ONGOING 'z1p03',
nohup python extract_erosita_tile_glist.py 19 > logs/extract_erosita_tile_19.log & # ONGOING 'z1p12',
