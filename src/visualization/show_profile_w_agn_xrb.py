...
p2_summary_file = os.path.join(prof_dir, 'FULL_SUMMARY_Mhalobin_centrals_'+Z_SEL+'.fits')


ALLT = []
for M_val in n.arange(11.0, 15.5, 0.5):
        print('='*100)
        print('='*100)
        print(M_val)
        ...
        p2_fig = os.path.join(prof_dir, 'CEN_ANY_AGN-XRB-hotGAS_'+Z_SEL+'_Mhalo_'+str(M_val)+'.png')
        p.figure(32, (5, 4.5) )
        # ALL
