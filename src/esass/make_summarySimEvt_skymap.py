...
for jj, sky_tile_value in enumerate(sky_map_hdu['SRVMAP']):
    ...
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_001_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_002_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_003_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_004_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_005_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_006_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_007_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_008_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_009_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_Att_eRASS8_sixte_v27_SEED_001_events_cluster'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'Att_eRASS8_sixte_v27_SEED_001_events_cluster', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_001_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_001_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_002_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_002_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_003_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_003_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_004_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_004_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_005_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_005_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_006_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_006_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_007_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_007_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_008_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_008_events_AGN_2025_04', '*.fits' ) ) ))
    sky_map_hdu['N_files_eRASS8_SEED_009_events_AGN_2025_04'] = len(n.array( glob.glob( os.path.join( "/home/idies/workspace/erosim/Uchuu/", LC_dir, str_field, 'eRASS8_SEED_009_events_AGN_2025_04', '*.fits' ) ) ))
