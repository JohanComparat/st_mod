...
sh GE_e4_merge_AGNseed001_SimBKG_CLUseed001_processing.sh
sh GE_e4_merge_AGNseed001_SimBKG_processing.sh
sh GE_e4_merge_SimBKG_CLUseed001_processing.sh
sh GE_e4_merge_SimBKG_processing.sh
