...
nohup python merge_events.py 1 1     > logs/merge_events_1_1.log  & # TODO
...
nohup python merge_events.py 2 2     > logs/merge_events_2_2.log  & # TODO
...
nohup python merge_events.py 3 3     > logs/merge_events_3_3.log  & # TODO
