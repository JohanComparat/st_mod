...
for GE_name in GE_names:
    ...
    if (N_per_batch > 0) & ((GE_name == 'GE_e4_merge_AGNseed004_SimBKG_CLUseed031') | (GE_name == 'GE_e4_merge_AGNseed009_SimBKG_CLUseed072') | (GE_name == 'GE_e4_merge_AGNseed001_SimBKG_CLUseed073')):
