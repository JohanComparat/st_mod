...
for GE_name in GE_names:
    ...
    if (N_per_batch > 0) & ((GE_name == 'GE_e4_merge_AGNseed004_SimBKG_CLUseed022') | (GE_name == 'GE_e4_merge_AGNseed005_SimBKG_CLUseed023') | (GE_name == 'GE_e4_merge_AGNseed007_SimBKG_CLUseed079')):
