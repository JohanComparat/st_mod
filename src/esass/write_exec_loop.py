...
for GE_name in GE_names:
    ...
    if (N_per_batch > 0) & ((GE_name == 'GE_e4_merge_AGNseed008_SimBKG_CLUseed026') | (GE_name == 'GE_e4_merge_AGNseed007_SimBKG_CLUseed088') | (GE_name == 'GE_e4_merge_AGNseed008_SimBKG_CLUseed089') | (GE_name == 'GE_e4_merge_AGNseed009_SimBKG_CLUseed090')):
