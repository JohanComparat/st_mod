...
for GE_name in GE_names:
    ...
    if (N_per_batch > 0) & ((GE_name == 'GE_e4_merge_AGNseed001_SimBKG_CLUseed028') | (GE_name == 'GE_e4_merge_AGNseed002_SimBKG_CLUseed029') | (GE_name == 'GE_e4_merge_AGNseed003_SimBKG_CLUseed030')):
