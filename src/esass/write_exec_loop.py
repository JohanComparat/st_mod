...
for GE_name in GE_names:
    ...
    if (N_per_batch > 0) & ((GE_name == 'GE_e5_merge_AGNseed007_SimBKG_CLUseed088') 
                          | (GE_name == 'GE_e5_merge_AGNseed008_SimBKG_CLUseed089')
                          | (GE_name == 'GE_e5_merge_AGNseed009_SimBKG_CLUseed090')
                          | (GE_name == 'GE_e5_merge_AGNseed001_SimBKG_CLUseed091')
                          | (GE_name == 'GE_e5_merge_AGNseed002_SimBKG_CLUseed092')
                          | (GE_name == 'GE_e5_merge_AGNseed003_SimBKG_CLUseed093')
                          | (GE_name == 'GE_e5_merge_AGNseed004_SimBKG_CLUseed094')
                          | (GE_name == 'GE_e5_merge_AGNseed005_SimBKG_CLUseed095')
                          | (GE_name == 'GE_e5_merge_AGNseed006_SimBKG_CLUseed096')
                          | (GE_name == 'GE_e5_merge_AGNseed007_SimBKG_CLUseed097')
                          | (GE_name == 'GE_e5_merge_AGNseed008_SimBKG_CLUseed098')
                          | (GE_name == 'GE_e5_merge_AGNseed009_SimBKG_CLUseed099')
                          | (GE_name == 'GE_e5_merge_AGNseed001_SimBKG_CLUseed101')
                          | (GE_name == 'GE_e5_merge_AGNseed002_SimBKG_CLUseed102')
                          | (GE_name == 'GE_e5_merge_AGNseed003_SimBKG_CLUseed103')
                          | (GE_name == 'GE_e5_merge_AGNseed004_SimBKG_CLUseed104')
                          | (GE_name == 'GE_e5_merge_AGNseed005_SimBKG_CLUseed105')
                          | (GE_name == 'GE_e5_merge_AGNseed006_SimBKG_CLUseed106')
                          | (GE_name == 'GE_e5_merge_AGNseed007_SimBKG_CLUseed107')
                          | (GE_name == 'GE_e5_merge_AGNseed008_SimBKG_CLUseed108')
                          | (GE_name == 'GE_e5_merge_AGNseed009_SimBKG_CLUseed109')
                          | (GE_name == 'GE_e5_merge_AGNseed001_SimBKG_CLUseed110')
                          | (GE_name == 'GE_e5_merge_AGNseed009_SimBKG_CLUseed117')
                          | (GE_name == 'GE_e4_merge_AGNseed005_SimBKG_CLUseed032')
                          | (GE_name == 'GE_e4_merge_AGNseed006_SimBKG_CLUseed033')
                          | (GE_name == 'GE_e4_merge_AGNseed007_SimBKG_CLUseed034')
                          | (GE_name == 'GE_e4_merge_AGNseed008_SimBKG_CLUseed035')
                          | (GE_name == 'GE_e4_merge_AGNseed009_SimBKG_CLUseed036')
                          | (GE_name == 'GE_e4_merge_AGNseed001_SimBKG_CLUseed037')
                          | (GE_name == 'GE_e4_merge_AGNseed002_SimBKG_CLUseed038')
                          | (GE_name == 'GE_e4_merge_AGNseed003_SimBKG_CLUseed039')):
