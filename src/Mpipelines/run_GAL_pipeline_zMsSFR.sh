...
nohup python GAL_pipeline_zMsSfr.py z0p00 FullSky > logs/GAL_pipeline_zMsSfr_z0p00_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p02 FullSky > logs/GAL_pipeline_zMsSfr_z0p02_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p05 FullSky > logs/GAL_pipeline_zMsSfr_z0p05_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p09 FullSky > logs/GAL_pipeline_zMsSfr_z0p09_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p14 FullSky > logs/GAL_pipeline_zMsSfr_z0p14_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p19 FullSky > logs/GAL_pipeline_zMsSfr_z0p19_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p25 FullSky > logs/GAL_pipeline_zMsSfr_z0p25_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p30 FullSky > logs/GAL_pipeline_zMsSfr_z0p30_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p36 FullSky > logs/GAL_pipeline_zMsSfr_z0p36_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p43 FullSky > logs/GAL_pipeline_zMsSfr_z0p43_FullSky.log & # DONE
nohup python GAL_pipeline_zMsSfr.py z0p49 FullSky > logs/GAL_pipeline_zMsSfr_z0p49_FullSky.log & # DONE
