...
for meta in C_GAL.LC_MetaData[(enough_area)&(small_difference_minmax_1)&(small_difference_minmax_2)]:
    ...
    if os.path.isfile(p_2_catalogue) and os.path.isfile(p_2_catal_MAG):
        ...
        def plot_LF_gr(
                mag_name = 'R'
                , mock_mag = MAG['r_mag']-MAG['dist_mod']
        ...
        plot_LF_gr(
                mag_name = 'G'
                , mock_mag = MAG['g_mag']-MAG['dist_mod']
        ...
        plot_LF_uizyjhk(
                mag_name = 'U'
                , mock_mag = MAG['u_mag']-MAG['dist_mod']
        ...
        plot_LF_uizyjhk(
                mag_name = 'I'
                , mock_mag = MAG['i_mag']-MAG['dist_mod']
        ...
        plot_LF_uizyjhk(
                mag_name = 'Z'
                , mock_mag = MAG['z_mag']-MAG['dist_mod']
        ...
        plot_LF_uizyjhk(
                mag_name = 'K'
                , mock_mag = MAG['k_mag']-MAG['dist_mod']
        ...
        ## Mock catalog
        #plt.hist(MAG['r_mag'], lw=2, weights=np.ones_like(MAG['r_mag']) / (  meta['mean_area'] ) ,
