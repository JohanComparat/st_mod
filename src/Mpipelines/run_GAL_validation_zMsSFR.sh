...
nohup python GAL_validation_zMsSFR.py z0p02 FullSky > logs/GAL_pipeline_zMsSfr_z0p02_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p05 FullSky > logs/GAL_pipeline_zMsSfr_z0p05_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p09 FullSky > logs/GAL_pipeline_zMsSfr_z0p09_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p14 FullSky > logs/GAL_pipeline_zMsSfr_z0p14_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p19 FullSky > logs/GAL_pipeline_zMsSfr_z0p19_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p25 FullSky > logs/GAL_pipeline_zMsSfr_z0p25_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p30 FullSky > logs/GAL_pipeline_zMsSfr_z0p30_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p36 FullSky > logs/GAL_pipeline_zMsSfr_z0p36_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p43 FullSky > logs/GAL_pipeline_zMsSfr_z0p43_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p49 FullSky > logs/GAL_pipeline_zMsSfr_z0p49_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p56 FullSky > logs/GAL_pipeline_zMsSfr_z0p56_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p63 FullSky > logs/GAL_pipeline_zMsSfr_z0p63_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p70 FullSky > logs/GAL_pipeline_zMsSfr_z0p70_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p78 FullSky > logs/GAL_pipeline_zMsSfr_z0p78_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p86 FullSky > logs/GAL_pipeline_zMsSfr_z0p86_FullSky.log & # TODO
nohup python GAL_validation_zMsSFR.py z0p94 FullSky > logs/GAL_pipeline_zMsSfr_z0p94_FullSky.log & # TODO
